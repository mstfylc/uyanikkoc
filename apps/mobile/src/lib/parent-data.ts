// Veli (parent) mobil verisi — kaynak: uyanikkoc-mobil-source-v3 (uk-data-parent.jsx).
// Tasarım mock'u TS'e portlandı (öğrenci ekranları gibi ileride API'ye bağlanabilir).

export type ParentOdev = {
  id: string;
  subject: string;
  topic: string;
  types: string[];
  ...
  due: string;
  status: "pending" | "done";
  result?: { d: number; y: number; b: number } | null;
};
...
export type ParentExam = {
  ...
  rank: string;
  delta: string;
  parts: { n: string; net: number; max: number }[];
};
...
export type ParentChild = {
  ...
  upcoming: { name: string; org: string; date: string; time: string };
  reports: ParentReport[];
};

export const P_CHILDREN: ParentChild[] = [
  {
    ...
    exams: [
      { id: "ce6", name: "TYT Genel Deneme #6", pub: "Uyanık Yayınları", type: "TYT", date: "1 Haz 2026", net: 88.0, rank: "~48.000", delta: "+1.75", parts: [{ n: "Türkçe", net: 35.0, max: 40 }, { n: "Sosyal", net: 15.25, max: 20 }, { n: "Matematik", net: 28.5, max: 40 }, { n: "Fen", net: 9.5, max: 20 }] },
      { id: "ce5", name: "TYT Genel Deneme #5", pub: "Uyanık Yayınları", type: "TYT", date: "24 May 2026", net: 86.25, rank: "~52.000", delta: "+5.5", parts: [{ n: "Türkçe", net: 33.75, max: 40 }, { n: "Sosyal", net: 14.0, max: 20 }, { n: "Matematik", net: 27.75, max: 40 }, { n: "Fen", net: 11.0, max: 20 }] },
      { id: "ce4", name: "TYT Genel Deneme #4", pub: "Şube Denemesi", type: "TYT", date: "17 May 2026", net: 80.75, rank: "~61.000", delta: "+1.25", parts: [{ n: "Türkçe", net: 31.5, max: 40 }, { n: "Sosyal", net: 12.75, max: 20 }, { n: "Matematik", net: 25.25, max: 40 }, { n: "Fen", net: 12.0, max: 20 }] },
    ],
  ...
  },
  {
    ...
    exams: [
      { id: "ke3", name: "Okul Deneme #3", pub: "Okul", type: "Genel", date: "30 May 2026", net: 198, rank: "Sınıf 4.", delta: "+12", parts: [{ n: "Türkçe", net: 18, max: 20 }, { n: "Matematik", net: 15, max: 20 }, { n: "Fen", net: 13, max: 20 }, { n: "Sosyal", net: 16, max: 20 }] },
      { id: "ke2", name: "Okul Deneme #2", pub: "Okul", type: "Genel", date: "16 May 2026", net: 186, rank: "Sınıf 6.", delta: "+8", parts: [{ n: "Türkçe", net: 17, max: 20 }, { n: "Matematik", net: 13, max: 20 }, { n: "Fen", net: 12, max: 20 }, { n: "Sosyal", net: 15, max: 20 }] },
    ],
...
export const P_PARENT = { name: "Ayşe Yıldız", initials: "AY", phone: "+90 5•• ••• 12 34" };

export const P_BILLING = {
