...
type CoachExamManualModalProps = {
  open: boolean;
  onClose: () => void;
  onSaved: () => void;
};

export function CoachExamManualModal({ open, onClose, onSaved }: CoachExamManualModalProps) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-panel" style={{ maxWidth: 640 }} onClick={(event) => event.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="modal-body" style={{ gap: 16 }}>
          ...
          <div className="grid g-2">
            <div className="field">
              <label className="label" htmlFor="manual-label">
                Etiket
              </label>
              <input
                id="manual-label"
            ...
            <div className="field">
              <label className="label" htmlFor="manual-takenAt">
                Tarih
              </label>
              <input
                id="manual-takenAt"
