  ...
  const studentMessages: MessageRecord[] = [
    {
      ...
      senderRole: "COACH",
      body: "Merhaba! Bu haftaki matematik ödevini unutma.",
      createdAt: timestamp,
    },
    {
      id: "msg_student_2",
      threadId: studentThreadId,
      senderRole: "STUDENT",
      body: "Tamam hocam, bugün bitireceğim.",
      createdAt: timestamp,
    },
    {
      id: "msg_student_3",
      threadId: studentThreadId,
      senderRole: "COACH",
      body: "Bitirince sonuç gir; doğru/yanlış üzerinden yarın programı ayarlayacağım.",
      createdAt: timestamp,
    },
  ];
  ...
  const groupMessages: MessageRecord[] = [
    {
      ...
      senderRole: "COACH",
      body: "TYT kamp grubu: Her gün 20 paragraf + 20 problem hedefini işaretleyin.",
      createdAt: timestamp,
    },
    {
      id: "msg_group_2",
      threadId: groupThreadId,
      senderRole: "STUDENT",
      body: "Hocam bugünkü problem setini tamamladım.",
      createdAt: timestamp,
    },
  ];
