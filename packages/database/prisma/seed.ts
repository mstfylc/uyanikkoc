  ...
  const assignments = [
    {
      ...
      week: "w0" as const,
      topic: "Problemler",
      source: "Hız ve Renk Problemler Soru Bankası",
      count: 40,
      odevType: "soru" as const,
      odevTypes: ["soru"],
    ...
    },
    {
      ...
      week: "w0" as const,
      topic: "Paragraf",
      source: "Bilgi Sarmal Paragraf",
      count: 30,
      odevType: "soru" as const,
      odevTypes: ["soru"],
      note: "Süreli paragraf testi.",
      type: "practice" as const,
    ...
    },
    {
      ...
      source: "TYT Deneme 3",
      count: 120,
      odevType: "test" as const,
      odevTypes: ["test"],
      note: "Yanlış ve boşları Yanlış Defteri'ne işle.",
    ...
    },
    {
      ...
      week: "w0" as const,
      topic: "Madde ve Isı",
      source: "LGS Fen Bilimleri Soru Bankası",
      count: 20,
      odevType: "test" as const,
      odevTypes: ["test"],
      note: "Mini deneme sonucu gir.",
      type: "exam_prep" as const,
      priority: "medium" as const,
      status: "completed" as const,
...
async function seedRichCoachAndParentFlows() {
  ...
  const notifications = [
    { id: "notification_demo_student_assignment", studentId: "student_001", parentId: null, coachId: null, title: "Yeni ödev", body: "Problemler karma tekrar ödevi atandı.", read: false, sourceKey: "demo:student:new-assignment", icon: "notebook", tone: "primary", page: "assignments" },
    { id: "notification_demo_student_mistake", studentId: "student_001", parentId: null, coachId: null, title: "Yanlış tekrarı", body: "Bugün 2 yanlış tekrar bekliyor.", read: false, sourceKey: "demo:student:mistake-review", icon: "clock", tone: "warning", page: "mistakes" },
    { id: "notification_demo_coach_risk", studentId: null, parentId: null, coachId: "coach_001", title: "Risk altında öğrenci", body: "Mert Demir 2 gündür program bloğu tamamlamadı.", read: false, sourceKey: "demo:coach:risk", icon: "chart", tone: "danger", page: "dashboard" },
    { id: "notification_demo_parent_report", studentId: null, parentId: "parent_001", coachId: null, title: "Haftalık gelişim raporu", body: "Elif için yeni veli raporu onay bekliyor.", read: false, sourceKey: "demo:parent:report", icon: "chart", tone: "info", page: "reports" },
  ];
