...
| 2026-06-12 | WEB V6 FINAL redeploy readiness | this commit | docs-only | Code ready yes; DB migrated yes; build/test passed yes; redeploy later completed; smoke blocked by missing role credentials |
| 2026-06-12 | WEB V6 FINAL production redeploy smoke | this commit | Vercel deploy OK; health status OK; org owner login OK; student/coach/parent smoke blocked | DB migration not rerun; role smoke needs valid production credentials |
...
| 2026-06-13 | WEB V6 REALITY parity delta | this commit | db:generate OK; typecheck OK; lint OK; unit OK; build OK; browser QA OK | `/coach/topics` source-backed order/copy/modal parity fixed; `.ktx=1`, `.ktx table=0`, mobile/desktop no overflow; no new design produced |
